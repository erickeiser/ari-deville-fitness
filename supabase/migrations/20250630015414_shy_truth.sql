...
-- Media files table policies - simplified to allow all authenticated users
...
CREATE POLICY "Enable update for authenticated users" ON public.media_files
FOR UPDATE USING (auth.role() = 'authenticated');

CREATE POLICY "Enable delete for authenticated users" ON public.media_files
