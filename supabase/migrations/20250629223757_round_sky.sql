...
CREATE POLICY "intake_submissions_insert_policy" ON intake_submissions
  FOR INSERT TO public WITH CHECK (true);

CREATE POLICY "intake_submissions_select_policy" ON intake_submissions
  FOR SELECT TO authenticated USING (true);

CREATE POLICY "intake_submissions_update_policy" ON intake_submissions
  FOR UPDATE TO authenticated USING (true) WITH CHECK (true);

-- Services Policies
CREATE POLICY "services_select_public_policy" ON services
  FOR SELECT TO public USING (active = true);

CREATE POLICY "services_all_authenticated_policy" ON services
  FOR ALL TO authenticated USING (true) WITH CHECK (true);

-- Testimonials Policies
CREATE POLICY "testimonials_select_public_policy" ON testimonials
  FOR SELECT TO public USING (active = true);

CREATE POLICY "testimonials_all_authenticated_policy" ON testimonials
  FOR ALL TO authenticated USING (true) WITH CHECK (true);
...
CREATE POLICY "media_files_all_authenticated_policy" ON media_files
  FOR ALL TO authenticated USING (true) WITH CHECK (true);
...
CREATE POLICY "site_content_all_authenticated_policy" ON site_content
  FOR ALL TO authenticated USING (true) WITH CHECK (true);
